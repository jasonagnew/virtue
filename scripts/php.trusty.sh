...
source ~/.virtue_config
  ...
  echo ">>> Installing PHP"
    ...
    sudo apt-get install -qq php5-cli php5-fpm php5-mysql php5-pgsql php5-sqlite php5-curl php5-gd php5-gmp php5-mcrypt php5-xdebug php5-memcached php5-imagick php5-intl libssh2-1-dev libssh2-php
